...
`resolve.py`, `ops.registry.op_registry_list`, and `ops.registry.op_registry_publish`
...
HARDWARE_VOICE_MANIFESTS = RegistryKind("hardware-voice-manifests", "yaml", False)
LLM_SERVERS = RegistryKind("llm-servers", "yaml", False)
