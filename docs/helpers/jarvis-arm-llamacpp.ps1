...
.DESCRIPTION
Manual helper for the JARVIS-AWF Windows ARM64 Adreno OpenCL sidecar build.
...
$jarvisRuntimeDir = Join-Path $jarvisRoot "runtimes\llama.cpp\windows-arm64-gpu"
...
try {
    ...
    # Phase 7: create JARVIS-AWF runtime staging directory.
    ...
    # Phase 8: deploy artifacts into the JARVIS-AWF runtime tree.
    Invoke-Step "Copy llama.cpp runtime artifacts into JARVIS-AWF" {
