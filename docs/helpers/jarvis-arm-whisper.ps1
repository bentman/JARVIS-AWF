<#
.SYNOPSIS
Create a JARVIS-AWF Whisper/QNN export fixture package.

.DESCRIPTION
Manual helper for AMD64-host fixture generation. The script keeps Qualcomm
Workbench export work outside the repo and writes the only intended JARVIS-AWF artifact
...
manifest = {
    "purpose": "JARVIS-AWF Whisper QNN artifact handoff for ARM64 validation",
    "sources": {},
    "files": [],
}
...
try {
    ...
    Write-Host "JARVIS-AWF model path after ARM64 staging: $jarvisModelPath"
